...
<body>
	...
	<form class="register" action="RegisterServlet" method="post"
		id="register" name="register" onsubmit="return validate()">
		<fieldset>
			<legend>Register</legend>
			<label for="username">Username</label> <input type="text"
				id="username" name="username" required> <br> <label
				for="password">Password</label> <input id="pass" type="password"
